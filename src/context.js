...
function getOriginalInjector(angular){
  if(!!inj){
    return inj;
  }
...
module.exports = function create(angular, context){
  context = context || defaultContext;

  var inj = getOriginalInjector(angular);
  ...
  function createInjector(modulesToLoad, strictDi) {
    ...
    instanceInjector.context = context;
    return instanceInjector;
  }
  createInjector.$$annotate = inj.annotate;
  return Object.assign(context, {injector: createInjector});
};
